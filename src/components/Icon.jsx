// Inline SVG icons — kept here so the bundle ships only what we use,
// and they all inherit color via currentColor.
//
// "brand" icons are filled (Simple Icons style) — for social marks
// "line" icons are stroked (Lucide style) — for utility/contact rows
...
const LINE_ICONS = {
  ...
  sunrise: (
    <path d="M12 2v8M4.93 10.93l1.41 1.41M2 18h2M20 18h2M17.66 12.34l1.41-1.41M22 22H2M8 6l4-4 4 4M16 18a4 4 0 0 0-8 0" />
  ),
  pencil: (
    <>
